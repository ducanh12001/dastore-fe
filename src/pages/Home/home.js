    ...
    useEffect(() => {
        (async () => {
            ...
            try {
                ...
                const response2 = await productApi.getProductsByCategory(data, "6454b6499ea4709774f44bdf");
                console.log(response2);
                setProductsPC(response2.data.docs);
                const response3 = await productApi.getProductsByCategory(data, "6454b5fd9ea4709774f44bdb");
                    ...
                    <Row justify="center" align="top" key="1" >
                        ...
                        <Col span={14}>
                            <Carousel autoplay className="carousel-image">
                                <div className="img">
                                    <img style={{ width: '100%', height: 300 }} src={banner} alt="" />

                                </div>
                                <div className="img">
                                    <img style={{ width: '100%', height: 300 }} src={banner2} />
